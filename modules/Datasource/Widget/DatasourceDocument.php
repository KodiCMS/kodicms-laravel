...
class DatasourceDocument extends Decorator implements WidgetCacheable
{
	...
	public function onLoad()
	{
		...
		foreach(['title', 'keywords', 'description'] as $metaKey)
		{
			...
			{
				Frontpage::setMetaParams('document_meta_' . $metaKey, $document->getAttribute($setting), 'meta_' . $metaKey);
			}
		}
	}
	...
	/**
	 * @return array [[Document] $rawDocument, [array] $document, [KodiCMS\Datasource\Contracts\SectionInterface] $section]
	 */
