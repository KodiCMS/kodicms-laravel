...
class Meta
{
    ...
    public function setPage(FrontendPage $page, $setPageData = false)
    {
        ...
        if ($setPageData !== false) {
            $this->setTitle(e($this->page->getMetaTitle()))->addMeta(['name'    => 'keywords',
                                                                      'content' => e($this->page->getMetaKeywords()),
                ])->addMeta(['name'    => 'description',
                             'content' => e($this->page->getMetaDescription()),
                ])->addMeta(['name'    => 'robots',
                             'content' => e($this->page->getMetaRobots()),
