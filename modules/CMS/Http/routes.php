...
RouteAPI::post('settings.update', ['as' => 'api.settings.update', 'uses' => 'API\SettingsController@post']);
RouteAPI::delete('cache.clear', ['as' => 'api.cache.clear', 'uses' => 'API\CacheController@deleteClear']);
