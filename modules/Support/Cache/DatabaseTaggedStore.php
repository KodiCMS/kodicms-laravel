...
class DatabaseTaggedStore extends TaggableStore implements Store
{
	/**
	...
	{
		return new DatabaseTaggedCache($this, new TagSet($this, is_array($names) ? $names : func_get_args()));
	}
