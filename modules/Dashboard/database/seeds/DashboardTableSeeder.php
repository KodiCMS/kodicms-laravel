			...
			\DB::table('user_meta')
				->insert([
					[
						...
						'value' => '{"555608fdd8cd4":{"id":"555608fdd8cd4","type":"mini_calendar","settings":[],"parameters":[]},"55560bdf5e7bc":{"id":"55560bdf5e7bc","type":"cache_button","settings":[],"parameters":[]},"5577076067b03":{"id":"5577076067b03","type":"kodicms_rss","settings":[],"parameters":[]}}'
					],
					[
						'user_id' => $user->id,
